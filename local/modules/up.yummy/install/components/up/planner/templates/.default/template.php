...
<div class="content">
	<div class="buttons" id="buttons">
		<a href="/planner/?day=<?=date('d.m.Y', $arResult['PREV_WEEK'])?>" id="prev_week_btn" class="ui-btn ui-btn-primary">Предыдущая неделя</a>
		<a href="/planner/" class="ui-btn ui-btn-primary" id="current_week_btn">Текущая неделя</a>
		<a href="/planner/?day=<?=date('d.m.Y',$arResult['NEXT_WEEK'])?>" id="next_week_btn" class="ui-btn ui-btn-primary">Следующая неделя</a>
	</div>
